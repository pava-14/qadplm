...
Не удалось реализовать автомаматическое тестирование двух СУБД одновременно, т.к. приложение gate-simulator не позволяет настраивать API для запуска нескольких экземпляров приложения одновременно.
