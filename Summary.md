...
Не удалось реализовать автомаматическое тестирование двух СУБД одновременно, т.к. приложение gate-simulator не позволяет настраивать доступность API для запуска нескольких экземпляров приложения одновременно.
