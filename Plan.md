...
12. **Заявка "Оплата по карте" не отправляется со значением месяца, больше допустимого, в поле "Месяц"**
...
13. **Заявка "Оплата по карте" не отправляется со значением месяца, меньше допустимого, в поле "Месяц"**
...
14. **Заявка "Кредит по данным карты" не отправляется со значением месяца, больше допустимого, в поле "Месяц"**
...
15. **Заявка "Кредит по данным карты" не отправляется со значением месяца, меньше допустимого, в поле "Месяц"**
