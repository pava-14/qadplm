...
9. **Проверка ввода значения года далекого будущего периода в поле "Год" заявки "Оплата по карте"**
...
11. **Проверка ввода значения года далекого будущего периода в поле "Год" заявки "Купить в кредит"**
...
12. **Проверка ввода значения месяца, больше допустимого, в поле "Месяц" заявки "Оплата по карте"**
...
13. **Проверка ввода значения месяца, меньше допустимого, в поле "Месяц" заявки "Оплата по карте"**
...
14. **Проверка ввода значения месяца, больше допустимого, в поле "Месяц" заявки "Купить в кредит"**
...
15. **Проверка ввода значения месяца, меньше допустимого, в поле "Месяц" заявки "Купить в кредит"**
...
16. **Пустая форма заявки "Оплата по карте" не отправляется в банк**
  ...
  *Ожидаемый результат:* У всех полей ввода появляются сообщения об ошибке "Неверный формат" или "Поле обязательно для заполнения". Заявка не отправляется.

17. **Пустая форма заявки "Купить в кредит" не отправляется в банк**
...
*TODO: Остальные поля на Неверный формат* 

18. **Проверка ввода невалидных данных в поля заявки "Оплата по карте"**
...
19. **Проверка ввода невалидных данных в поля заявки "Кредит по данным карты":**
...
20. После успешной заявки "Купить в кредит", данные о платеже сохраняются в базе данных MySQL.
21. После успешной заявки "Купить", данные о платеже сохраняются в базе данных MySQL.
22. После отклоненной заявки "Купить в кредит", данные о платеже не сохраняются в базе данных MySQL.
23. После отклоненной заявки "Купить", данные о платеже не сохраняются в базе данных MySQL.
24. После успешной заявки "Купить в кредит", данные о платеже сохраняются в базе данных PostgreSQL.
25. После успешной заявки "Купить", данные о платеже сохраняются в базе данных PostgreSQL.
26. После отклоненной заявки "Купить в кредит", данные о платеже не сохраняются в базе данных PostgreSQL.
27. После отклоненной заявки "Купить", данные о платеже не сохраняются в базе данных PostgreSQL.
